...
"/rowcolor[HTML]{FFFFFF} \n",
"/multicolumn{1}{l}{/cellcolor[HTML]{FFFFFF}/textbf{}} & /textbf{$/delta(I_{/text{s}})$}  & /textbf{$/delta(N)$} & /textbf{$/delta(Y)$}  // /midrule \n",
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Spouse Number} & ",     sn$Ims[3]," (", sn$ImsL[3],", ",sn$ImsH[3],") &",   sn$Spouses[3]," (", sn$SpousesL[3] ,", ", sn$SpousesH[3],") & // \n"   ),
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Marital Years} & ",   sy$Ims[3]," (", sy$ImsL[3],", ",sy$ImsH[3],") &", "","", "" ,"", ""," &", sy$SpouseYears[3]," (", sy$SpouseYearsL[3],", ",  sy$SpouseYearsH[3] ,") // \n"   ),
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Marital Years: Marriage Timing Weights} & ",    sq$Ims[3]," (", sq$ImsL[3],", ",sq$ImsH[3],") &", "","", "" ,"", ""," &", sq$SpouseYears[3]," (", sq$SpouseYearsL[3],", ",  sq$SpouseYearsH[3] ,") //  \n"   ),
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Marital Years: Spousal Quality Weights} & ",    pq$Ims[3]," (", pq$ImsL[3],", ",pq$ImsH[3],") &", "","", "" ,"", ""," &", pq$SpouseYears[3]," (", pq$SpouseYearsL[3],", ",  pq$SpouseYearsH[3] ,") // \n"   ),
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Marital Years: Both Weights} & ", sqpq$Ims[3]," (", sqpq$ImsL[3],", ",sqpq$ImsH[3],") &" ,"","", "" ,"", ""," &", sqpq$SpouseYears[3]," (", sqpq$SpouseYearsL[3],", ",  sqpq$SpouseYearsH[3] ,") //  \n"   ),
paste0("/rowcolor[HTML]{FFFFFF}/cellcolor[HTML]{FFFFFF}/textbf{Full Model} & ",    snpqsq$Ims[3]," (", snpqsq$ImsL[3],", ",snpqsq$ImsH[3],") &",  snpqsq$Spouses[3]," (", snpqsq$SpousesL[3] ,", ", snpqsq$SpousesH[3],") &", snpqsq$SpouseYears[3]," (", snpqsq$SpouseYearsL[3],", ",  snpqsq$SpouseYearsH[3] ,") // /bottomrule"   )
  )
sink()

...
//################################################################ Male Parameters
  ...
  vector[1] Phi_males;                           // Quality Model Parameters
...
//################################################################ Female Parameters
  ...
  vector[1] Phi_females;                         // Quality Model Parameters
  ...
  for (a in 1:Age_males[i]){
   if(PartnersByAge1_males[i,a+11]==0){ESA[1] = 0;}
         ...
         for(b in 1:MaxExposure){
          Scrap[b] = MissingDataWeights_males[b]*inv_logit(Phi_males[1] + SpouseAgeEffect_males[b]);}
          ESA[1] = sum(Scrap);}
    else{ ESA[1] = inv_logit(Phi_males[1] + SpouseAgeEffect_males[PartnersByAge1_males[i,a+11]]);}}
   ...
   if(PartnersByAge2_males[i,a+11]==0){ESA[2] = 0;}
         ...
         for(b in 1:MaxExposure){
          Scrap[b] = MissingDataWeights_males[b]*inv_logit(Phi_males[1] + SpouseAgeEffect_males[b]);}
          ESA[2] = sum(Scrap);}
    else{ ESA[2] = inv_logit(Phi_males[1] + SpouseAgeEffect_males[PartnersByAge2_males[i,a+11]]);}}
   ...
   if(PartnersByAge3_males[i,a+11]==0){ESA[3] = 0;}
         ...
         for(b in 1:MaxExposure){
          Scrap[b] = MissingDataWeights_males[b]*inv_logit(Phi_males[1] + SpouseAgeEffect_males[b]);}
          ESA[3] = sum(Scrap);}
    else{ ESA[3] = inv_logit(Phi_males[1] + SpouseAgeEffect_males[PartnersByAge3_males[i,a+11]]);}}
   ...
   if(PartnersByAge4_males[i,a+11]==0){ESA[4] = 0;}
         ...
         for(b in 1:MaxExposure){
          Scrap[b] = MissingDataWeights_males[b]*inv_logit(Phi_males[1] + SpouseAgeEffect_males[b]);}
          ESA[4] = sum(Scrap);}
    else{ ESA[4] = inv_logit(Phi_males[1] + SpouseAgeEffect_males[PartnersByAge4_males[i,a+11]]);}}
   ...
   if(PartnersByAge5_males[i,a+11]==0){ESA[5] = 0;}
         ...
         for(b in 1:MaxExposure){
          Scrap[b] = MissingDataWeights_males[b]*inv_logit(Phi_males[1] + SpouseAgeEffect_males[b]);}
          ESA[5] = sum(Scrap);}
    else{ ESA[5] = inv_logit(Phi_males[1] + SpouseAgeEffect_males[PartnersByAge5_males[i,a+11]]);}}
 ...
 for (i in 1:N_females){
  for (a in 1:Age_females[i]){
   if(PartnersByAge1_females[i,a+11]==0){EffectiveSpousesByAge_females[i,a] = 0;}
         ...
         for(b in 1:MaxExposure){
         Scrap[b] = MissingDataWeights_females[b]*inv_logit(Phi_females[1] + SpouseAgeEffect_females[b]);}
         EffectiveSpousesByAge_females[i,a] = sum(Scrap);}
     else{EffectiveSpousesByAge_females[i,a] = inv_logit(Phi_females[1] + SpouseAgeEffect_females[PartnersByAge1_females[i,a+11]]);}}
     }}

...
//################################################################################################################################
  SpouseAgeEffect_males ~ multi_normal_cholesky(rep_vector(0,MaxExposure), Quick_GP_L(MaxExposure, Theta_males[1], Zeta_males[1], Gamma_males[1]) );
  SpouseAgeEffect_females ~ multi_normal_cholesky(rep_vector(0,MaxExposure), Quick_GP_L(MaxExposure, Theta_females[1], Zeta_females[1], Gamma_females[1]) );
 
  MarriageAgeEffect_males ~ multi_normal_cholesky(rep_vector(0,MaxExposure), Quick_GP_L(MaxExposure, Theta_males[2], Zeta_males[2], Gamma_males[2]) );
  MarriageAgeEffect_females ~ multi_normal_cholesky(rep_vector(0,MaxExposure), Quick_GP_L(MaxExposure, Theta_females[2], Zeta_females[2], Gamma_females[2]) );
...
if(Zeros_males[i] != 1)
 ...
 A_males[15] = exp(Beta_males[1] + Beta_males[2]*log(Age_males[15]) + Beta_males[3]*log(ImpNS[1]) + exp(Beta_males[4])*log(ImpYM[1]))*B_males[15];
 A_males[78] = exp(Beta_males[1] + Beta_males[2]*log(Age_males[78]) + Beta_males[3]*log(ImpNS[2]) + exp(Beta_males[4])*log(ImpYM[2]))*B_males[78];
 A_males[111] = exp(Beta_males[1] + Beta_males[2]*log(Age_males[111]) + Beta_males[3]*log(ImpNS[3]) + exp(Beta_males[4])*log(ImpYM[3]))*B_males[111];
 A_males[134] = exp(Beta_males[1] + Beta_males[2]*log(Age_males[134]) + Beta_males[3]*log(ImpNS[4]) + exp(Beta_males[4])*log(ImpYM[4]))*B_males[134];
...
if(Zeros_females[i] != 1)
 ...
 A_females[94] = exp(Beta_females[1] + Beta_females[2]*log(Age_females[94]) + Beta_females[3]*log(ImpNS[5]) + exp(Beta_females[4])*log(ImpYM[5]))*B_females[94];

...
"/rowcolor[HTML]{C0C0C0} \n",
paste0("/multirow{-2}{*}{/cellcolor[HTML]{FFFFFF}/textbf{Marital Years}} & ","F& ",   sy$Ims[2]," (", sy$ImsL[2],", ",sy$ImsH[2],") &", sy$Incpt[2]," (", sy$IncptL[2] ,", ", sy$IncptH[2],") &",  sy$Age[2]," (",  sy$AgeL[2],", ",  sy$AgeH[2],") &", ""," ", "" ,"", ""," &", sy$SpouseYears[2]," (", sy$SpouseYearsL[2],", ",  sy$SpouseYearsH[2] ,") &",  round(sy$WAIC[2],2) ," &" ,  round(sy$dWAIC[2],2)," &" ,  round(sy$wWAIC[2],2),  "// /midrule \n"   ),
"/rowcolor[HTML]{EFEFEF} \n ",
...
"/rowcolor[HTML]{C0C0C0} \n",
paste0("/multirow{-2}{*}{/cellcolor[HTML]{FFFFFF}/textbf{Marital Years: Marriage Timing Weights}} & ","F &",   sq$Ims[2]," (", sq$ImsL[2],", ",sq$ImsH[2],") &", sq$Incpt[2]," (", sq$IncptL[2] ,", ", sq$IncptH[2],") &",  sq$Age[2]," (",  sq$AgeL[2],", ",  sq$AgeH[2],") &", "","", "" ,"","","&", sq$SpouseYears[2]," (", sq$SpouseYearsL[2],", ",  sq$SpouseYearsH[2] ,") &",  round(sq$WAIC[2],2) ," &" ,  round(sq$dWAIC[2],2)," &" ,  round(sq$wWAIC[2],2) ,"// /midrule \n"  ),
"/rowcolor[HTML]{EFEFEF} \n",
...
"/rowcolor[HTML]{C0C0C0} \n",
paste0("/multirow{-2}{*}{/cellcolor[HTML]{FFFFFF}/textbf{Marital Years: Spousal Quality Weights}} & ","F& ",     pq$Ims[2]," (", pq$ImsL[2],", ",pq$ImsH[2],") &", pq$Incpt[2]," (", pq$IncptL[2] ,", ", pq$IncptH[2],") &",  pq$Age[2]," (",  pq$AgeL[2],", ",  pq$AgeH[2],") &", ""," ", "" ,"", ""," &", pq$SpouseYears[2]," (", pq$SpouseYearsL[2],", ",  pq$SpouseYearsH[2] ,") &",    round(pq$WAIC[2],2) ," &" ,  round(pq$dWAIC[2],2)," &" ,  round(pq$wWAIC[2],2),  "// /midrule \n"   ),
"/rowcolor[HTML]{EFEFEF} \n ",
